<?php
	...
	$transformFunctions = [
		...
		'firmas' => function($data, $options = []) {
			if(isset($data['id'])) $data['id'] = pkGivenLookupText($data['id'], 'firmas', 'id');
	...
	$filterFunctions = [
		'visita' => function($data, $options = []) { return true; },
		'firmas' => function($data, $options = []) { return true; },
	];
